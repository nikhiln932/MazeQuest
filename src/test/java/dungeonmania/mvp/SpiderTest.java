...
public class SpiderTest {
    ...
    public void boulder() {
        ...
        int y = pos.getY();
        List<Position> movementTrajectory = new ArrayList<>();
        movementTrajectory.add(new Position(x, y - 1)); //5,4
        movementTrajectory.add(new Position(x + 1, y - 1)); // 6, 4
        movementTrajectory.add(new Position(x, y - 1)); // 5, 4
        movementTrajectory.add(new Position(x - 1, y - 1)); // 4, 4
        movementTrajectory.add(new Position(x - 1, y)); // 4, 5
        movementTrajectory.add(new Position(x - 1, y + 1)); //4, 6
        movementTrajectory.add(new Position(x, y + 1)); //5 ,6
        movementTrajectory.add(new Position(x + 1, y + 1)); // 6, 6
        movementTrajectory.add(new Position(x, y + 1)); //5, 6
        movementTrajectory.add(new Position(x - 1, y + 1)); // 5, 6
        movementTrajectory.add(new Position(x - 1, y)); // 4, 5
        movementTrajectory.add(new Position(x - 1, y - 1)); // 4, 4
        movementTrajectory.add(new Position(x, y - 1)); //5, 4
        movementTrajectory.add(new Position(x + 1, y - 1)); //6, 4
