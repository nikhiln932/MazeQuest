...
public class TestUtils {
    ...
    public static List<ItemResponse> getInventory(DungeonResponse res, String type) {
        return res.getInventory().stream().filter(it -> it.getType().equals(type)).collect(Collectors.toList());
    }
    ...
    public static Stream<EntityResponse> getEntitiesStream(DungeonResponse res, String type) {
        return res.getEntities().stream().filter(it -> it.getType().equals(type));
    }
    ...
    public static int countEntitiesOfType(DungeonResponse response, String type) {
        return response.getEntities().stream().filter(e -> e.getType().equals(type)).collect(Collectors.toList())
                .size();
    }
    ...
    public static int countEntityOfType(List<EntityResponse> entities, String type) {
        return entities.stream().filter(e -> e.getType().equals(type)).collect(Collectors.toList()).size();
    }
