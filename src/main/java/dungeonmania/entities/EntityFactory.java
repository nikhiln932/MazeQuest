...
import dungeonmania.entities.logicalEntities.logicStrategies.AndLogic;
import dungeonmania.entities.logicalEntities.logicStrategies.CoAndLogic;
import dungeonmania.entities.logicalEntities.logicStrategies.LogicStrategy;
import dungeonmania.entities.logicalEntities.logicStrategies.OrLogic;
import dungeonmania.entities.logicalEntities.logicStrategies.XorLogic;
...
public class EntityFactory {
    ...
    public LightBulb buildBulb(Position pos, LogicStrategy logic) {
        return new LightBulb(pos, logic);
    }

    public SwitchDoor buildSwitchDoor(Position pos, LogicStrategy logic) {
    ...
    private Entity constructEntity(JSONObject jsonEntity, JSONObject config) {
        ...
        LogicStrategy logic = null;
        if (!jsonEntity.isNull("logic")) {
            logic = getLogic(jsonEntity.getString("logic"));
        }
    ...
    private LogicStrategy getLogic(String logicType) {
        switch (logicType) {
        case "or":
            return new OrLogic();
        case "and":
    ...
    public Buildable getBuildable(String entityType) {
        switch (entityType) {
        case "bow":
            return buildBow();
        case "shield":
